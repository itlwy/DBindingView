package com.lwy.dbindingview.common;
...
public class AdapterReferenceCollector {
     ...
     */
    public static <T, A extends IBindingCollectionAdapter<T>> WeakReference<A> createRef(A adapter, ObservableList<T> items, ObservableList.OnListChangedCallback callback) {
    ...
    static class AdapterRef<T, A extends IBindingCollectionAdapter<T>> extends WeakReference<A> {
