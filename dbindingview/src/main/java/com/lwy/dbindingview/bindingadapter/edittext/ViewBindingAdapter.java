...
public final class ViewBindingAdapter {
    ...
    @BindingAdapter(value = {"regularExpression"})
    public static void edittextRegularPattern(final EditText editText, final String regularExpression) {
        editText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (!s.toString().matches(regularExpression) && !"".equals(s.toString())) {
